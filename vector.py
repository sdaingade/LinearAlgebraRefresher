...
"""
 ...
 2. Perform a scalar multiplication of vector with 1/magnitude(v)
    (divide vector by magnitude). This gives unti vector in the direction of v
...
is to simply multiply the number of degree by Π /180°

The general formula for converting from radians to degrees
is to simply multiply the number of radians by 180°/(Π)
...
= (Vector(v)* unit vector(B)) * unit vector(B)
  See my_parallel_to method above
"""
...
* Vector(V) cross Vector(W) = - (Vwctor(W) cross Vector(V))
  anti-commutative
...
print("Projection of v1 onto v2: {}".format(proj_v1.my_parallel_to(proj_v2)))

proj_v3 = Vector([-9.88, -3.264, -8.159])
proj_v4 = Vector([-2.155, -9.353, -9.473])
print("Orthogonal of v3 onto v4: {}".format(proj_v3.my_orthogonal_to(proj_v4)))

proj_v5 = Vector([3.009, -6.172, 3.692, -2.51])
proj_v6 = Vector([6.404, -9.144, 2.759, 8.718])
print("Projection of v5 onto v6: {}".format(proj_v5.my_parallel_to(proj_v6)))
print("Orthogonal of v5 onto v6: {}".format(proj_v5.my_orthogonal_to(proj_v6)))
